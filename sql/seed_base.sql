...
INSERT OR IGNORE INTO algorithms (
    ...
    (16, 'eye_close_yolo', '闭眼YOLO版', '行为分析', '[{"key":"confidence","label":"置信度","type":"slider","default":0.5,"min":0,"max":1,"step":0.01},{"key":"duration","label":"持续闭眼时间(秒)","type":"number","default":10,"min":1,"max":30,"step":1},{"key":"skip_frame","label":"跳帧数","type":"number","default":5,"min":1,"max":30,"step":1}]', 'by'),
    (17, 'yawning_yolo', '打哈欠YOLO版', '行为分析', '[{"key":"confidence","label":"置信度","type":"slider","default":0.5,"min":0,"max":1,"step":0.01},{"key":"min_yawn_open_sec","label":"最短张嘴时长(秒)","type":"number","default":0.8,"min":0.1,"max":5,"step":0.1},{"key":"yawn_duration","label":"判定时间窗口(秒)","type":"number","default":180,"min":30,"max":600,"step":10},{"key":"yawn_count","label":"哈欠次数阈值","type":"number","default":3,"min":1,"max":20,"step":1},{"key":"skip_frame","label":"跳帧数","type":"number","default":5,"min":1,"max":30,"step":1}]', 'dhq');
